...
### Important Configuration for Google Cloud Shell

When running this project in Google Cloud Shell, please note the following configuration change:

- In the [`docker-compose.yml`](https://github.com/spurin/diveintoansible-lab/blob/0e4427f9b1b91905318e53c452eb96e886d8561d/docker-compose.yaml#L147) file, change the port mapping from `1000:80` to `8080:80`:
